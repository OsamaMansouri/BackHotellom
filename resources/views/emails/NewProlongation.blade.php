															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper"
																		...
																		<p style="color: #000000; font-size: 19px; line-height: 22px; text-align: left;">New Prolongation has been added Seccessfully.																		</p>
																	</div>
																</div>
															</td>
														</tr>
																	...
																	<span
																		style="padding-left:50px;padding-right:45px;font-size:18px;display:inline-block;letter-spacing:normal;"><span
																			style="font-size: 12px; line-height: 2; word-break: break-word; mso-line-height-alt: 24px;"><span
																				...
																				style="font-size: 18px; line-height: 36px;"><a href="https://api.hotellom.com/edit-password/" style="text-decoration:none;color: #ffffff;">Continue</a></span></span></span>
																</div>
															</td>
														</tr>
													</table>
