																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper"
																		...
																		<p
																			...
																			<span style="font-size:15px;">Your Account
																				Has Been Successfully Registered Click
																				on button Below to Login .</span></p>
																	</div>
																</div>
															</td>
														</tr>
																	...
																	<span
																		style="padding-left:50px;padding-right:45px;font-size:18px;display:inline-block;letter-spacing:normal;"><span
																			style="font-size: 12px; line-height: 2; word-break: break-word; mso-line-height-alt: 24px;"><span
																				...
																				style="font-size: 18px; line-height: 36px;"><a href="http://preprod.hotellom.com" style="text-decoration:none;color:#fff">Continue</a></span></span></span>
																</div>
															</td>
														</tr>
													</table>
